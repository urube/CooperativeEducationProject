...
describe('Question Seven', () => {  
  describe('BloodBank.displayPositiveDonations function', () => {
    ...
    describe('Donation', () => {
      var donation
      beforeEach(() => {
        donation = new Donation('branchName', 'town', '6/15/2019', 'bloodGroup')
      })
      ...
      it('should NOT be hard coded', () => {
        expect(donation.toString()).toBe('Has blood group <bloodGroup> donated on 6/15/2019 at branchName\n\t')
      })
      ...
      describe('Display positive donations function returns positive blood donors format', () => {
        ...
        describe('Donor\'s first Donation', () => {
          ...
          it('should display donation date', () => {
            expect(output).toMatch('1/12/2018')
          })
      ...
      describe('Second Donor\'s first Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).toMatch('9/11/2017')
        })
      ...
      describe('Second Donor\'s second Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).toMatch('5/10/2018')
        })
  ...
  describe('DiplayPositiveDonations function', () => {
    it('should work perectly', () => {
      ...
      expect(theBloodBank.displayPositiveDonations()).toBe(
        'Moore, Sandy [F]\n\t'
        + 'Has blood group <AB+> donated on 1/12/2018 at Christchurch\n\t'
        + 'Watson, Cathy [F]\n\t'
        + 'Has blood group <O+> donated on 11/07/2019 at Auckland\n\t'
        + 'Watts, Jonathan [M]\n\t'
        + 'Has blood group <AB+> donated on 9/11/2017 at Nelson\n\t'

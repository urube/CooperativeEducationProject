...
describe('Question Seven', () => {  
  describe('BloodBank.displayPositiveDonations function', () => {
    ...
    describe('BloodBank.displayPositiveDonations function', () => {
      it('should return a string', () => {
        expect(typeof theBloodBank.displayPositiveDonations()).to.equal('string');
      })

      it('should NOT be hard coded', () => {
        theBloodBank = new BloodBank()
        expect(theBloodBank.displayPositiveDonations()).to.equal('');
      })
	...
	describe('BloodBank.displayDonors function', () => {
	  ...
	  it('should return a string', () => {
        expect(typeof theBloodBank.displayDonors()).to.equal('string');
      })

      it('should NOT be hard coded', () => {
        theBloodBank = new BloodBank()
        expect(theBloodBank.displayDonors()).to.equal('');
      })
    ...
    describe('Donor.hasPositiveBloodGroup function', () => {
      ...
      it('should return true if the blood group is AB+.', () => {
        expect(theDonor.hasPositiveBloodGroup('AB+')).to.be.ok;
      })
    })
    ...
    describe('Donor.getDonations function', () => {
      ...
      it('should exist', () => {
        expect(theDonor.getDonations()).not.to.be.undefined;
      })

      it('getDonations function should return', () => {
        expect(typeof theDonor.getDonations()).to.equal('string');
    })
  })
    ...
    describe('Donation', () => {
      ...
      it('should return a string', () => {
        expect(typeof donation.toString()).to.equal('string');
      })

      it('should NOT be hard coded', () => {
        expect(donation.toString()).to.equal('Has blood group <bloodGroup> donated on 6/15/2019 at branchName');
      })
      ...
      describe('Display positive donations function returns positive blood donors format', () => {
        ...
        describe('Donor\'s first Donation', () => {
          ...
          it('should display donation date', () => {
            expect(output).to.match('12/1/2018');
          })
      ...
      describe('Second Donor\'s first Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).to.match('11/9/2017');
        })
      ...
      describe('Second Donor\'s second Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).to.match('10/5/2018');
        })
  ...
  describe('DiplayPositiveDonations function', () => {
    it('should work perectly', () => {
      ...
      expect(theBloodBank.displayPositiveDonations()).to.equal('Moore, Sandy [F]\n'
      + '\tHas blood group <AB+> donated on 12/1/2018 at Christchurch\n'
      + 'Watson, Cathy [F]\n'
      + '\tHas blood group <O+> donated on 7/15/2019 at Auckland\n'
      + 'Watts, Jonathan [M]\n'
      + '\tHas blood group <AB+> donated on 11/9/2017 at Nelson\n'
      + '\tHas blood group <AB+> donated on 10/5/2018 at Otago\n');
    })
  })
})
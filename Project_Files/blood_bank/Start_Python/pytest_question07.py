...
class TestBloodBankDisplayDonors:
    ...
    def test_bx_display_donor__str__exists(self, set_data):
        donor = set_data
        assert type(donor).__str__ is not object.__str__

    def test_by_display_donor__str__returns_string(self, set_data):
        donor = set_data
        returned = str(donor)
        assert isinstance(returned, str)

    def test_bz_display_donor__str__works(self, set_data):
        donor = set_data
        returned = str(donor)
...
class TestDonorHasPositiveBloodGroupFunction:
    ...
    def test_yx_donor_has_positive_blood_group_exists(self, set_data):
        donor = set_data
        assert hasattr(donor, 'has_positive_blood_group')
        assert callable(getattr(donor, 'has_positive_blood_group', None))

    def test_yy_has_positive_blood_group_returns_false_with_zero_donors(self, set_data):
        donor = set_data
        returned = donor.has_positive_blood_group()
        assert returned == False

    def test_yz_has_positive_blood_group_should_be_true(self, set_data):
        donor = set_data
...
class TestDonorHasGetDonationsFunction:
    ...
    def test_za_donor_has_get_donations_exists(self, set_data):
        donor = set_data
        assert hasattr(donor, 'get_donations')
        assert callable(getattr(donor, 'get_donations', None))

    def test_zb_donor_has_get_donations_str_returns_string(self, set_data):
        donor = set_data

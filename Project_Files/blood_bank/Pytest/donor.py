...
class Donor:
    ...
    def has_positive_bloodgroup(self):
        result = False
    ...
    def sort_donation(self):
        self.all_my_donations = sorted(self.all_my_donations, key=lambda donation: donation.branch_name)

    def add_donation(self, new_branch_name, new_town, new_when, new_blood_group):
        new_donation = Donor(new_branch_name, new_town, new_when, new_blood_group)

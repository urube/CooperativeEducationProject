...
describe('Question Seven', () => {
  ...
  describe('Kennel.getThoseWithOneDog function', () => {
    it('should return a string', () => {
      expect(typeof theKennel.getThoseWithOneDog()).to.equal('string');
    })
    it('should NOT be hard coded', () => {
      theKennel = new Kennel()
      expect(theKennel.getThoseWithOneDog()).to.equal('');
    })
    ...
    describe('The punctuation after the first name', () => {
      it(' should be a comma and then a space', () => {
        expect(theKennel.getThoseWithOneDog()).to.match(/^Brad,\s/);
      })
    })
    
    describe('The second name', () => {
      it('should be McCaw', () => {
        expect(theKennel.getThoseWithOneDog()).to.match(/^Brad, McCaw/);
      })
    })
    
    describe('The punctuation after the second name', () => {
      it('should just be a space', () => {
        expect(theKennel.getThoseWithOneDog()).to.match(/McCaw\s/);
      })
    })
    
    describe('The id ', () => {
      it('should have BMC enclosed in [] ie [BMC]', () => {
        expect(theKennel.getThoseWithOneDog()).to.match(/\[BMC\]/);
      })
    })
    ...
    describe('Each Dog\'s details', () => {
      it('should start with a tab \\t character', () => {
        expect(theKennel.getThoseWithOneDog()).to.match(/\n\t/);
      })
    })

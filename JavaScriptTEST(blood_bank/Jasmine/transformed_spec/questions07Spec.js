  ...
  describe('BloodBank.displayPositiveDonations function', () => {
    ...
    describe('BloodBank.displayPositiveDonations function', () => {
      ...
      it('DiplayPositiveDonations function should return', () => {
        expect(typeof theBloodBank.displayPositiveDonations()).to.deep.equal('string');
      })
    })
	...
	describe('BloodBank.displayDonors function', () => {
      ...
      it('DiplayDonors function should return', () => {
       expect(typeof theBloodBank.displayDonors()).to.deep.equal('string');
      })
    })
    ...
    describe('Donor.getDonations function', () => {
      ...
      it('getDonations function should return', () => {
        expect(typeof theDonor.getDonations()).to.deep.equal('string');
    })
  })
    ...
    describe('Donation', () => {
      ...
      it('should NOT be hard coded', () => {
        expect(donation.toString()).to.equal('Has blood group <bloodGroup> donated on 15/06/2019 at branchName');
      })
      
      it('toString function should return', () => {
        expect(typeof donation.toString()).to.deep.equal('string');
      })
    })
      ...
      describe('Second Donor\'s first Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).to.match('09/11/2017');
        })
      ...
      describe('Second Donor\'s second Donation', () => {
        ...
        it('should display donation date', () => {
          expect(output).to.match('05/10/2018');
        })
